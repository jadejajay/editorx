...
const data = [
  {
    type: 'Humlan P',
    imageUri: 'http://itekindia.com/sharva/products/cabinet/1%20%284%29.png',
  ...
  {
    type: 'Pampas',
    imageUri: 'http://itekindia.com/sharva/products/cabinet/1%20%281%29.png',
  ...
  {
    type: 'Humlan P',
    imageUri: 'http://itekindia.com/sharva/products/cabinet/1%20%282%29.png',
  ...
  {
    type: 'Humlan B',
    imageUri: 'http://itekindia.com/sharva/products/cabinet/1%20%283%29.png',
    heading: 'From Sweden',
    description:
  ...
  return (
    <View style={styles.container}>
      ...
      <Image
        style={styles.logo}
        source={{
          uri: 'http://itekindia.com/sharva/products/cabinet/1%20%284%29.png',
        }}
      />
      <Pagination
        scrollOffsetAnimatedValue={scrollOffsetAnimatedValue}
...
const styles = StyleSheet.create({
  ...
  tickerText: {
    fontSize: TICKER_HEIGHT - 5,
    lineHeight: TICKER_HEIGHT - 5,
    textTransform: 'uppercase',
    fontWeight: '800',
  },
