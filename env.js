 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.editorx.staging
 */

const BUNDLE_ID = 'com.editorx'; // ios bundle id
const PACKAGE = 'com.editorx'; // android package name
const NAME = 'editorx'; // app name
